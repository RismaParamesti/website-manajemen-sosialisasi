...
const Office = () => {
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Perkantoran");
    XLSX.writeFile(workbook, "Perkantoran.xlsx");
  };

  const handleExportPDF = () => {
    const doc = new jsPDF();
    doc.text("Data Perkantoran", 10, 10);
    ...
    <div className="min-h-screen bg-base-200 px-6 py-10 space-y-12">
      ...
      <div className="bg-base-100 p-6 rounded-xl shadow-lg">
        <h3 className="text-center font-semibold text-xl mb-1">
          Persentase Sosialisasi Perkantoran Berdasarkan Wilayah
        </h3>
